...
import TicketView from "@/components/attendee/my-tickets/TicketView";
                  ...
                  <div className="border-y border-y-gray-300 border-r border-r-gray-300 rounded-r-xl h-60 w-full pl-5 py-5 flex flex-col justify-between">
                    ...
                    <div className="flex gap-3">
                      <button
                        ...
                        className="cursor-pointer flex items-center font-medium gap-2 rounded-lg border border-gray-300 py-2 px-4 text-[15px]"
                      >
